...
例:
    # 基本的な使用方法
    $0 -i i-1234567890abcdef0 -f tasks/phase0-setup.json

    # 変数を指定
    $0 -i i-1234567890abcdef0 -f tasks/phase0-setup.json \\
       -v '{"VIVADO_VERSION":"2025.2"}'

    # 特定のタスクから再開
    $0 -i i-1234567890abcdef0 -f tasks/phase0-setup.json \\
       -s 03-configure-vivado

    # ドライラン（実行内容の確認）
    $0 -i i-1234567890abcdef0 -f tasks/phase0-setup.json --dry-run
EOF
}
